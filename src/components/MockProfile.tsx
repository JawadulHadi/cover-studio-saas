    ...
    <div className="bg-[#0a0a0a] border border-[#1a1a1a] rounded-xl overflow-hidden shadow-2xl" id="mock-profile-preview">
      ...
      <div className="bg-[#0a0a0a] text-[#e5e5e5] p-0 relative">
        ...
        <div className="relative w-full select-none">
          ...
          <div
            className={`absolute z-10 aspect-square rounded-full border-4 border-[#0a0a0a] bg-[#111] transition-all duration-300 shadow-xl overflow-hidden flex items-center justify-center ${
              isMobile
          ...
          >
            {config.customAvatarUrl ? (
              ...
              <div className="flex flex-col items-center justify-center text-center p-1">
                ...
                <span className="text-[#888] text-[8px] font-mono leading-none hidden md:inline">AVATAR AREA</span>
              </div>
            )}
          </div>
        </div>
