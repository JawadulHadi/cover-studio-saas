...
const DEFAULT_CONFIG: BannerConfig = {
  ...
  customLogoUrl: "",
  customAvatarUrl:
    "https://storage.googleapis.com/iagility-apac/profile_pic_68fa610c3a50f116c7311d73_cropped-image_1784862177704.jpg", // Generic stock headshot
...
export default function App() {
  ...
  const handleTriggerExport = () => {
    if (triggerExportRef.current) {
      ...
      showToast(
        "High-resolution LinkedIn cover (1584x396px) generated and downloaded!",
      );
    }
  };
  ...
  return (
    <div
      className="min-h-screen bg-[#050505] text-[#e5e5e5] app-glow-grid flex flex-col font-sans relative"
      id="studio-app-root">
      ...
      <header className="border-b border-[#111] bg-[#0a0a0a]/80 backdrop-blur-md sticky top-0 z-40 px-4 sm:px-6 py-4 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 hidden md:block">
              Design high-end, minimalist LinkedIn cover banners for any
              profession — AI-assisted copy & safe-zone guides
            </p>
          </div>
        </div>
        ...
        <section className="space-y-4" id="banner-canvas-section">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <button
                onClick={() =>
                  handleUpdateConfig({ gridOverlay: !config.gridOverlay })
                }
              ...
              <button
                onClick={() =>
                  handleUpdateConfig({
                    showProfileSafeZone: !config.showProfileSafeZone,
                  })
                }
                className={`px-3 py-1.5 rounded-lg border text-xs font-bold flex items-center gap-1.5 transition-all cursor-pointer ${
            ...
            <div className="bg-[#0a0a0a] border border-[#1a1a1a] rounded-xl p-5 space-y-4">
              ...
              <ul className="space-y-3 text-xs text-[#888888]">
                <li className="flex items-start gap-2.5">
                  ...
                  <span>
                    <strong>Rule of Left-Pushed Typography</strong>: Always
                    group your name, position, and taglines on the center-right
                    (offset x &gt; 420px). This ensures your text completely
                    avoids being covered by the avatar on both desktop and
                    mobile devices.
                  </span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-1.5 shrink-0" />
                  <span>
                    <strong>Bento Grid Metrics Alignment</strong>: Fill out your
                    accomplishments (Experience, Certifications, SaaS
                    statistics) on the far right block. This balances the visual
                    weight of the left-aligned avatar.
                  </span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-blue-400 mt-1.5 shrink-0" />
                  <span>
                    <strong>Clean Digital Grid</strong>: Use the{" "}
                    <em>Sophisticated Dark</em> or <em>Deep Space</em> presets
                    for engineering cover designs. Grid lines represent highly
                    structured systems and engineering cleanliness.
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-[#050505]/60 rounded-lg p-3.5 border border-[#111] flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#666]">
                    1584x396px output at exactly 4:1 aspect ratio, meeting
                    LinkedIn's precise uploading standards.
                  </p>
                </div>
              </div>
            </div>
      ...
      <footer className="mt-12 border-t border-[#111] bg-[#050505]/80 py-6 px-6 text-center text-xs text-[#555]">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <p>
            © 2026 Qeloma Cover Studio. Craft a standout LinkedIn banner in
            minutes.
          </p>
